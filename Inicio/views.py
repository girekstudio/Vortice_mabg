...
def seccion_filtro(request,secc):
    ...
    contexto ={
        ...
        'productss': Product.objects.filter(prenda__coleccion__seccion__seccion=secc).order_by('-id'),
        'blogs': Blogs.objects.all(),
        'categorias': Categoria.objects.all(),
        'redes': Contacto_redes.objects.all().first(),
    }
...
def tipo_filtro(request,seccion,tipo):
    contexto ={
        ...
        'redes': Contacto_redes.objects.all().first(),
        'product': Product.objects.filter(articulo__seccion__seccion=seccion, articulo__tipo__tipo=tipo).order_by('-id'),
        'products': Product.objects.filter(prenda__coleccion__seccion__seccion=seccion, prenda__tipo__tipo=tipo).order_by('-id'),
        'blogs': Blogs.objects.all(),
        'categorias': Categoria.objects.all(),
    }
    return render(request, 'categories.html', contexto)
...
def coleccion_filtro(request,seccion,coleccion):
    contexto ={
        ...
        'prod': Product.objects.filter(prenda__coleccion__seccion__seccion=seccion,prenda__coleccion__tema=coleccion).order_by('-id'),
        'productss': Product.objects.filter(prenda__coleccion__tema=coleccion ).order_by('-id'),
        'blogs': Blogs.objects.all(),
        'categorias': Categoria.objects.all(),
    }
...
def coleccion_filtro_prenda(request,seccion,coleccion,tipo):
    contexto ={
        ...
        'redes': Contacto_redes.objects.all(),
        'product': Product.objects.filter(articulo__seccion__seccion=seccion, articulo__tipo__tipo=tipo).order_by('-id'),
        'products': Product.objects.filter(prenda__coleccion__seccion__seccion=seccion, prenda__coleccion__tema=coleccion, prenda__tipo__tipo=tipo).order_by('-id'),
        'blogs': Blogs.objects.all(),
        'categorias': Categoria.objects.all(),
    }
    return render(request, 'coleccion.html', contexto)
...
def producto_detalle(request,id):
    contexto = {
        ...
        'prenda': Prenda.objects.all(),
        'seccion': Seccion_Cliente.objects.all(),
        'products': Product.objects.get(id=id).order_by('-id'),
        'redes': Contacto_redes.objects.all(),
        'blogs': Blogs.objects.all(),
        'categorias': Categoria.objects.all(),
    }
